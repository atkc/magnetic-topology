...
%         plot = 3;
%           
%         gR - the output struct contaning the histogram_PCB
...
%         
%         NumOfBins - number of bins in the final histogram_PCB
%
%         output:
%         ~~~~~~~
%         gR is a histogram_PCB struct contaning:
%                 gR.count - total number of object counted
%                 gR.range - x axis range for the histogram_PCB
...
%       a histogram_PCB, and normalizing each bin with it's Ideal gas number of
%       particals. 
...
%     |important|
%       -------
%       this function uses the functions "histogram_PCB", "distPBC2D"
%       "histogram_PCB" can be found here: http://www.cchem.berkeley.edu/chem195/histogram_PCB_8m.html#aedd379efd57ae78820ad8787bfab0cce
...
%       
        ...
        switch switchVal
            ...
            case initialize
                % Initialize a histogram_PCB to hold the radial distribution
