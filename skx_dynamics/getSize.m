...
mode=2;%1:xy from fullstat2 2:xy from masterlist
if mode ==1
...
pid_list=[5 6 7 38 39 40]%unique(p_sub);
...
%*****3a.Dsk vs Theta (for each j)*****
%******3b.Dsk vs Vsk (for each j)******
...
[~,jid]=ismember(p_id_partial,p_sub);
abs(i1(jid))

i_use=mean(abs(i1(jid)));
%vlim=5.46
%for vlim = 0;%[10.06,7.76,5.46,3.16]
