function varargout = genGrid(bounds, origin, size, varargin)
...
pts5 = squareGrid(bounds, origin + [-dx/3 0], [dx dy], varargin{:});
pts6 = squareGrid(bounds, origin + [+dx/6 dy/2], [dx dy], varargin{:});
