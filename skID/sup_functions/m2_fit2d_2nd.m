function [isofit,unfitno,fit_status,er]=m2_fit2d_2nd(radius,centroids, dgrayIm, name,maxr,checkInd,imageSize,maskId)
%Description:
%This version of m2_fit2d fits a UNWEIGHTED GAUSSIAN to dgrayIm
...
%         a=tmpiso.a;
    ...
    if maskId
        fun=@(xt)(Gfun2D(size(portion),xt(1),xt(2),xt(3),xt(4),xt(5))-portion).*cmask';
    end
